 ...
 */
package com.zs.ina.registration.preview;
 ...
 * @author sumesh
 */
public class FXMLRegistrationPreviewController implements Initializable {
    ...
    public void showHideFeatures(String tab, boolean hideShow) {
        switch (tab) {
            case "study":
                ...
                lblPreviewTitle.setText("Registration Form - Study");
            ...
            case "work":
                ...
                vboxSpouseDetails.setVisible(hideShow);
                vboxSpouseDetails.setManaged(hideShow);
                lblPreviewTitle.setText("Registration Form - Work");
            ...
            case "migration":
                ...
                vboxLanguageSkill.setVisible(hideShow);
                vboxLanguageSkill.setManaged(hideShow);
                lblPreviewTitle.setText("Registration Form - Migration");
            ...
            case "training":
                ...
                vboxLanguageSkill.setVisible(hideShow);
                vboxLanguageSkill.setManaged(hideShow);
                lblPreviewTitle.setText("Registration Form - Training");
