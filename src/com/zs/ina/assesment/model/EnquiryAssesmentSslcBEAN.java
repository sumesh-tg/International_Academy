 ...
 * @author zoft
 */
public class EnquiryAssesmentSslcBEAN {
 //   String board, medium, status;
  //  String mark;
    int flag;
    ...
    public String toString() {
        return "EnquiryAssesmentSslcBEAN{" + "flag=" + flag + ", board=" + board + ", medium=" + medium + ", status=" + status + ", mark=" + mark + '}';
    }
