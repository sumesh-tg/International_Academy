...
import com.zs.ina.admin.inbox.empstatus.FXMLEmployeStatusFullController;
 ...
 * @author zscomp1
 */
public class FXMLAdminInboxViewController implements Initializable {

    static Logger logger = Logger.getLogger(FXMLAdminInboxViewController.class);
...
//        resetSearchWithImgView();
        ...
        //    Map<String, List<CounselorDetailsBEAN>> primaryInboxMap = InboxRetrievalService.getPrimaryInbox(CUR_BRANCH, CUR_USERNAME);
        ...
        serviceHyperLinkCounts.stateProperty().addListener(new ChangeListener<Worker.State>() {
            ...
            public void changed(ObservableValue<? extends Worker.State> observable, Worker.State oldValue, Worker.State newValue) {
                switch (newValue) {
                    ...
                    case SUCCEEDED:
                        System.out.println("Succededd");
                        System.out.println("test data :: " + serviceHyperLinkCounts.getValue());
...
//        notifyTimer.play();
    ...
    public void addFollowUpRegister() {
        ...
        for (InboxCountsBEAN inboxCountsBEAN : listInboxCounts) {
            System.out.println("test " + listInboxCounts.toString());
            ...
            if (inboxCountsBEAN.getStatusId() != null) {
                if (inboxCountsBEAN.getStatusId().equalsIgnoreCase("-1")) {
                    ...
                    System.out.println("today count>>>" + inboxCountsBEAN.getTotalCount());
                }
            }
        }
...
//        datePickTo.setPromptText(pattern.toLowerCase());
 ...
 /* ======================== Add Enquiry Hold flag ==================== */
        ...
        Image imgGlobalYellowStar = new Image(FXMLAdminInboxViewController.class.getResourceAsStream("stary.png"));
        Image imgGlobalWhiteStar = new Image(FXMLAdminInboxViewController.class.getResourceAsStream("starw.png"));
        ...
        ImageView imageViewPlaceHolder = new ImageView(new Image(FXMLAdminInboxViewController.class.getResourceAsStream("images/no_enq_show.png")));
...
//                new PropertyValueFactory<>("count"));
        ...
        /* ====================== Only For Admin ====================== */
        TableColumn clmTabCounselorName = new TableColumn("Counselor Name");
        clmTabCounselorName.setCellValueFactory(new PropertyValueFactory<>("CounselorName"));
        TableColumn clmTabCounselorBranch = new TableColumn("Counselor Branch");
        clmTabCounselorBranch.setCellValueFactory(new PropertyValueFactory<>("bracnch"));
        ...
        clmTabEdit.setCellFactory(new Callback<TableColumn<CounselorDetailsBEAN, CounselorDetailsBEAN>, TableCell<CounselorDetailsBEAN, CounselorDetailsBEAN>>() {
            ...
            public TableCell<CounselorDetailsBEAN, CounselorDetailsBEAN> call(TableColumn<CounselorDetailsBEAN, CounselorDetailsBEAN> param) {
                return new TableCell<CounselorDetailsBEAN, CounselorDetailsBEAN>() {
                    ...
                    Image editIcon = new Image(FXMLAdminInboxViewController.class
...
//        }
        ...
        switch (tabName) {
            case "study":
                if (!IS_COMMON_POOL) {
                    tableName.getColumns().addAll(clmChkMark, clmTabPriority, clmTabFlag, clmTabCname, clmTabPhone, clmTabQualification, clmTabLanguageTest, clmTabAdmissionTest, clmTabExperience, clmTabStudyRequired, clmTabStudyCountryLocation, clmTabApplicationStatus, clmTabRemarks, clmTabCounselorName, clmTabCounselorBranch, clmTabEnquiryBy, clmTabForward, clmTabAddress, clmTabDate);
                } else {
                    tableName.getColumns().addAll(clmChkMark, clmTabPriority, clmTabCname, clmTabPhone, clmTabQualification, clmTabLanguageTest, clmTabAdmissionTest, clmTabExperience, clmTabStudyRequired, clmTabStudyCountryLocation, clmTabApplicationStatus, clmTabRemarks, clmTabCounselorName, clmTabCounselorBranch, clmTabEnquiryBy, clmTabForward, clmTabAddress, clmTabDate);
                }
                break;
            case "work":
                if (!IS_COMMON_POOL) {
                    tableName.getColumns().addAll(clmChkMark, clmTabPriority, clmTabFlag, clmTabCname, clmTabPhone, clmTabQualification, clmTabLanguageTest, clmTabExperience, clmTabWorkRequired, clmTabSalaryExpected, clmTabWorkCountryLocation, clmTabApplicationStatus, clmTabRemarks, clmTabCounselorName, clmTabCounselorBranch, clmTabEnquiryBy, clmTabForward, clmTabAddress, clmTabDate);
                } else {
                    tableName.getColumns().addAll(clmChkMark, clmTabPriority, clmTabCname, clmTabPhone, clmTabQualification, clmTabLanguageTest, clmTabExperience, clmTabWorkRequired, clmTabSalaryExpected, clmTabWorkCountryLocation, clmTabApplicationStatus, clmTabRemarks, clmTabCounselorName, clmTabCounselorBranch, clmTabEnquiryBy, clmTabForward, clmTabAddress, clmTabDate);
                }

                break;
            case "migration":
                if (!IS_COMMON_POOL) {
                    tableName.getColumns().addAll(clmChkMark, clmTabPriority, clmTabFlag, clmTabCname, clmTabPhone, clmTabQualification, clmTabLanguageTest, clmTabAdmissionTest, clmTabExperience, clmTabMigrationRequired, clmTabApplicationType, clmTabMigrationCountryLocation, clmTabApplicationStatus, clmTabRemarks, clmTabCounselorName, clmTabCounselorBranch, clmTabEnquiryBy, clmTabForward, clmTabAddress, clmTabDate);
                } else {
            ...
            case "training":
                if (!IS_COMMON_POOL) {
                    tableName.getColumns().addAll(clmChkMark, clmTabPriority, clmTabFlag, clmTabCname, clmTabPhone, clmTabQualification, clmTabLanguageTest, clmTabAdmissionTest, clmTabExperience, clmTabTrainingRequired, clmTabJoiningDate, clmTabBatch, clmTabApplicationStatus, clmTabRemarks, clmTabCounselorName, clmTabCounselorBranch, clmTabEnquiryBy, clmTabForward, clmTabAddress, clmTabDate);
                } else {
                    tableName.getColumns().addAll(clmChkMark, clmTabPriority, clmTabCname, clmTabPhone, clmTabQualification, clmTabLanguageTest, clmTabAdmissionTest, clmTabExperience, clmTabTrainingRequired, clmTabJoiningDate, clmTabBatch, clmTabApplicationStatus, clmTabRemarks, clmTabCounselorName, clmTabCounselorBranch, clmTabEnquiryBy, clmTabForward, clmTabAddress, clmTabDate);
                }
                break;
        }
...
//        stageAppointment.initStyle(StageStyle.UNDECORATED);
                    ...
                    public void handle(ActionEvent event) {
                        ...
                        try {
                            ...
                            if (listCheckedEnquiries.size() > 0) {
                                if (IS_COMMON_POOL) {
                                    /* ======================== Removing From Common Pool After Forward ==================== */
                                    controller.forwardMultipleEnquiries(listCheckedEnquiries, popForward, tableName, "ROLE_COUNSELOR");
                                } else {
 ...
 /* ======================== Fires MousEvent Of Common Pool ==================== */
                                    Event.fireEvent(hyperCommonPool, new MouseEvent(MouseEvent.MOUSE_CLICKED, 0,
                                            0, 0, 0, MouseButton.PRIMARY, 1, true, true, true, true,
                                            true, true, true, true, true, true, null));
                                    listCheckedEnquiries.clear();
                ...
                if (row.getItem() != null) {
                    if (row.getItem().getImportant() != null) {
                        System.out.println("Test ing Important Flag :: " + row.getItem().getImportant());
                        if (row.getItem().getImportant().equalsIgnoreCase("1")) {
                            contextMenu.getItems().addAll(itemOpenEnquiry);
                        } else {
                            contextMenu.getItems().addAll(itemOpenEnquiry, itemForwardEnquiry);
                        }
                    } else {
                        contextMenu.getItems().addAll(itemOpenEnquiry, itemForwardEnquiry);
                    }
    ...
    private void initTodayFollowUpCount() {
        ...
        for (InboxCountsBEAN inboxCountsBEAN : listInboxCounts) {
            if (inboxCountsBEAN.getStatusId() != null) {
                if (inboxCountsBEAN.getStatusId().equals("-1")) {
                    lblTitleFollowUp.setText("");
                    lblTitleFollowUp.setText("Follow Up (Today " + inboxCountsBEAN.getTotalCount() + ")");
                    //  folloupsize = Integer.parseInt(inboxCountsBEAN.getTotalCount());
                }
            }
        }
 ...
 /* ===================================================================== */
    ...
    public class PriorityCell extends TableCell {
        ...
        Image yellowStarImage = new Image(FXMLAdminInboxViewController.class.getResourceAsStream("stary.png"));
        Image whiteStarImage = new Image(FXMLAdminInboxViewController.class.getResourceAsStream("starw.png"));
        Image yellowImrtantImage = new Image(FXMLAdminInboxViewController.class.getResourceAsStream("impy.png"));
        Image whiteImportantImage = new Image(FXMLAdminInboxViewController.class.getResourceAsStream("impw.png"));
...
//                    }
    ...
    public class FlagCell extends TableCell {
        ...
        //   Tooltip tooltip = new Tooltip();
        {
            hboxPriority.getChildren().addAll(importantimageView);
            hboxPriority.setAlignment(Pos.CENTER);
            setGraphic(hboxPriority);
        }
            ...
            if (!empty) {
                ...
                if (object != null) {
                    ...
                    if (cpojo.getImportant() == null || cpojo.getImportant().equals("0")) {
                        importantimageView.setImage(whiteImportantImage);
                        importantimageView.setFitWidth(24);
                        importantimageView.setFitHeight(16);
                    } else {
                        importantimageView.setImage(yellowImrtantImage);
                        importantimageView.setFitWidth(24);
...
//                    importantimageView.setCursor(new ImageCursor(new Image(INALoginForm.class.getResourceAsStream("images/cursor_hand_red.png"))));
//                    importantimageView.setOnMouseClicked(new EventHandler<Event>() {
//
//                        @Override
//                        public void handle(Event event) {
...
//        private ObservableValue<T> ov;
        ...
        public void updateItem(Object item, boolean empty) {
            ...
            if (empty) {
                ...
                /* ======================== Disabel Check Box For Disable Forwarding ==================== */
                if (!IS_COMMON_POOL) {
                    if (cpojo.getImportant() != null) {
                        if (cpojo.getImportant().equalsIgnoreCase("1")) {
...
//                }
    ...
    public void addClearOnControls() {
        ...
        cmbAssignBy.setItems(RetrieveStaticMasterDAO.getAllUsersByBranch(null));
