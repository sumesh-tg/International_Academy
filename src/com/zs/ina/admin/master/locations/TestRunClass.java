...
import com.zs.ina.admin.master.counselorlimit.*;
...
public class TestRunClass extends Application {
    ...
    public void start(Stage primaryStage) throws IOException {
        ...
        Pane myPane = null;
        FXMLLoader loader = new FXMLLoader(getClass().getResource("/com/zs/ina/admin/master/locations/FXMLLocations.fxml"));
