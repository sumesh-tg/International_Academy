 ...
 * @author 100035
 */
public class ConfigPoolSERVICE {

    ConfigPoolDAO configPoolDAO = new ConfigPoolIMPL();
    ...
    public ObservableList<String> retrieveBranches() {
        return configPoolDAO.retrieveBranches();
    }
    ...
    public ObservableList<NamePOJO> retrieveFullNames(String branch) {
        return configPoolDAO.retrieveFullNames(branch);
    }
    ...
    public int insertConfigPool(ConfigPoolBEAN configPoolBEAN) {
        return configPoolDAO.insertConfigPool(configPoolBEAN);
    }
    ...
    public ObservableList<ConfigPoolBEAN> retrieveConfigPool() {
        return configPoolDAO.retrieveConfigPool();
    }
    ...
    public int updateConfigPool(ConfigPoolBEAN configPoolBEAN) {
        return configPoolDAO.updateConfigPool(configPoolBEAN);
    }
    ...
    public int deleteConfigPool(String cofigPoolId) {
     return configPoolDAO.deleteConfigPool(cofigPoolId);
    }
}
