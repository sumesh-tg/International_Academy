 ...
 * @author 100035
 */
public class FXMLMeetingListController implements Initializable {
    ...
    @FXML
    private Label lblEventNames;
    @FXML
    private Label lblStartDates;
    @FXML
    private Label lblEndDates;
    ...
    public void passEventDetails(AppointmentScheduleBEAN appointmentScheduleBEAN) {
        System.out.println("test beann inside FXMLEventsForAnchorController::" + appointmentScheduleBEAN.toString());
        lblEventName.setText(appointmentScheduleBEAN.getMeetingName());
