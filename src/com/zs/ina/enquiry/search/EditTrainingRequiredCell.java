...
import com.zs.ina.enquiry.search.editing.FXMLTrainingRequiredController;
 ...
 * @author 100018
 */
public class EditTrainingRequiredCell extends TableCell<CounselorDetailsBEAN, String> {
     ...
     *
     */
    public EditTrainingRequiredCell() {
    }
    ...
    private void createTextField() {
        ...
        textField.setOnMouseClicked(new EventHandler<MouseEvent>() {
            ...
            public void handle(MouseEvent event) {
                ...
                FXMLLoader loader = new FXMLLoader(getClass().getResource("/com/zs/ina/enquiry/search/editing/FXMLTrainingRequired.fxml"));
                try {
                    Parent root = (Parent) loader.load();
                    // System.out.println(loader.getController());
                    FXMLTrainingRequiredController controller = (FXMLTrainingRequiredController) loader.getController();
                    ...
                    popmsg.setTitle("View/Edit Training Required Details ");
