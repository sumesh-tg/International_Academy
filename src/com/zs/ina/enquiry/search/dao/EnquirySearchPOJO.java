...
public class EnquirySearchPOJO {
    ...
    private String studyPrgms,workPrgms,migratePrgms,trainingPgms;

    /**
     *
     * @return
     */
    public String getStudyPrgms() {
        return studyPrgms;
    }
     ...
     * @param studyPrgms
     */
    public void setStudyPrgms(String studyPrgms) {
        this.studyPrgms = studyPrgms;
    }
     ...
     * @param workPrgms
     */
    public void setWorkPrgms(String workPrgms) {
        this.workPrgms = workPrgms;
    }
     ...
     * @param migratePrgms
     */
    public void setMigratePrgms(String migratePrgms) {
        this.migratePrgms = migratePrgms;
    }
     ...
     * @param trainingPgms
     */
    public void setTrainingPgms(String trainingPgms) {
        this.trainingPgms = trainingPgms;
    }
    ...
    public String getContactDetails() {
        ...
        contactDetails = "" + getContactName() + "," + "" + getContactEmail() + ","
                + "" + getContactNumber();
        return contactDetails;
    }
