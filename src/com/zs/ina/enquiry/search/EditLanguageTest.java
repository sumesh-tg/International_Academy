...
import com.zs.ina.enquiry.search.editing.FXMLLanguageTestController;
 ...
 * @author 100018
 */
public class EditLanguageTest extends TableCell<CounselorDetailsBEAN, String> {
    ...
    private void createTextField() {
        ...
        textField.setOnMouseClicked(new EventHandler<MouseEvent>() {
            ...
            public void handle(MouseEvent event) {
                ...
                FXMLLoader loader = new FXMLLoader(getClass().getResource("/com/zs/ina/enquiry/search/editing/FXMLLanguageTest.fxml"));
                try {
                    Parent root = (Parent) loader.load();
                    // System.out.println(loader.getController());
                    FXMLLanguageTestController controller = (FXMLLanguageTestController) loader.getController();
                    ...
                    popmsg.setTitle("View/Edit Language Test Details ");
