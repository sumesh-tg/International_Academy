...
import com.zs.ina.enquiry.search.editing.FXMLExperienceController;
 ...
 * @author 100018
 */
public class EditExperience extends TableCell<CounselorDetailsBEAN, String> {
    ...
    private void createTextField() {
        ...
        textField.setOnMouseClicked(new EventHandler<MouseEvent>() {
            ...
            public void handle(MouseEvent event) {
                ...
                FXMLLoader loader = new FXMLLoader(getClass().getResource("/com/zs/ina/enquiry/search/editing/FXMLExperience.fxml"));
                try {
                    popmsg = new PopOver();
                    Parent root = (Parent) loader.load();
                    // System.out.println(loader.getController());
                    FXMLExperienceController controller = (FXMLExperienceController) loader.getController();
                    ...
                    popmsg.setTitle("View/Edit Work Experience Details ");
