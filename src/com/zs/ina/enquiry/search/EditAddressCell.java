...
import com.zs.ina.enquiry.search.editing.FXMLDistrictStateCountryController;
 ...
 * @author 100018
 */
public class EditAddressCell extends TableCell<CounselorDetailsBEAN, String> {
    ...
    private void createTextField() {
        ...
        textField.setOnMouseClicked(new EventHandler<MouseEvent>() {
            ...
            public void handle(MouseEvent event) {
                ...
                FXMLLoader loader = new FXMLLoader(getClass().getResource("/com/zs/ina/enquiry/search/editing/FXMLDistrictStateCountry.fxml"));
                try {
                    Parent root = (Parent) loader.load();
                    // System.out.println(loader.getController());
                    FXMLDistrictStateCountryController controller = (FXMLDistrictStateCountryController) loader.getController();
                    ...
                    popmsg.setTitle("View/Edit Address Details ");
