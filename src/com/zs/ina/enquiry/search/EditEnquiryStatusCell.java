 ...
 * @author 100018
 */
public class EditEnquiryStatusCell extends TableCell<CounselorDetailsBEAN, String> {
    ...
    private void createTextField() {
        ...
        textField.setOnMouseClicked(new EventHandler<MouseEvent>() {
            ...
            public void handle(MouseEvent event) {
                ...
                FXMLLoader loader = new FXMLLoader(getClass().getResource("/com/zs/ina/enquiry/search/editing/FXMLChangeEnquiryStatus.fxml"));
                try {
                    Parent root = (Parent) loader.load();
                    // System.out.println(loader.getController());
                    //  FXMLChangeEnquiryStatusController controller = (FXMLChangeEnquiryStatusController) loader.getController();
                    ...
                    popmsg.setTitle("View/Edit Enquiry Status ");
