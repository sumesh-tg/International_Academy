...
import com.zs.ina.enquiry.search.editing.FXMLContactNumbersController;
 ...
 * @author 100018
 */
public class EditContactNumbers extends TableCell<CounselorDetailsBEAN, String> {

    private PopOver popmsg = new PopOver();
    private TextField textField;

    /**
     *
     */
    public EditContactNumbers() {
    }
    ...
    private void createTextField() {
        ...
        textField.setOnMouseClicked(new EventHandler<MouseEvent>() {
            ...
            public void handle(MouseEvent event) {
                ...
                FXMLLoader loader = new FXMLLoader(getClass().getResource("/com/zs/ina/enquiry/search/editing/FXMLContactNumbers.fxml"));
                try {
                    Parent root = (Parent) loader.load();
                    // System.out.println(loader.getController());
                    FXMLContactNumbersController controller = (FXMLContactNumbersController) loader.getController();
                    Context.getInstance().currentProfile().setPopOver(popmsg);
                    Context.getInstance().currentProfile().setNode(textField);
                    ...
                    popmsg.setDetached(true);
                    popmsg.setDetachable(true);
                    popmsg.setTitle("View/Edit ContactNumbers ");
