...
import com.zs.ina.enquiry.search.editing.FXMLAdmissionTestController;
 ...
 * @author 100018
 */
public class EditAdmissionTest extends TableCell<CounselorDetailsBEAN, String> {
    ...
    private void createTextField() {
        ...
        textField.setOnMouseClicked(new EventHandler<MouseEvent>() {
            ...
            public void handle(MouseEvent event) {
                ...
                FXMLLoader loader = new FXMLLoader(getClass().getResource("/com/zs/ina/enquiry/search/editing/FXMLAdmissionTest.fxml"));
                try {
                    Parent root = (Parent) loader.load();
                    // System.out.println(loader.getController());
                    FXMLAdmissionTestController controller = (FXMLAdmissionTestController) loader.getController();
                    ...
                    popmsg.setTitle("View/Edit Admission Test Details ");
