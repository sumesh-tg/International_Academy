...
import com.zs.ina.enquiry.search.editing.FXMLStudyRequiredController;
 ...
 * @author 100018
 */
public class EditStudyRequiredCell extends TableCell<CounselorDetailsBEAN, String> {
    ...
    private void createTextField() {
        ...
        textField.setOnMouseClicked(new EventHandler<MouseEvent>() {
            ...
            public void handle(MouseEvent event) {
                ...
                FXMLLoader loader = new FXMLLoader(getClass().getResource("/com/zs/ina/enquiry/search/editing/FXMLStudyRequired.fxml"));
                try {
                    Parent root = (Parent) loader.load();
                    // System.out.println(loader.getController());
                    FXMLStudyRequiredController controller = (FXMLStudyRequiredController) loader.getController();
                    ...
                    popmsg.setTitle("View/Edit Study Required Details ");
