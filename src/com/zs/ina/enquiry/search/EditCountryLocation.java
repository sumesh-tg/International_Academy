...
import com.zs.ina.enquiry.search.editing.FXMLCountryLocationController;
 ...
 * @author 100018
 */
public class EditCountryLocation extends TableCell<CounselorDetailsBEAN, String> {
    ...
    private void createTextField() {
        ...
        textField.setOnMouseClicked(new EventHandler<MouseEvent>() {
            ...
            public void handle(MouseEvent event) {
                ...
                FXMLLoader loader = new FXMLLoader(getClass().getResource("/com/zs/ina/enquiry/search/editing/FXMLCountryLocation.fxml"));
                try {
                    Parent root = (Parent) loader.load();
                    // System.out.println(loader.getController());
                    FXMLCountryLocationController controller = (FXMLCountryLocationController) loader.getController();
                    ...
                    popmsg.setTitle("View/Edit Country & Location Details ");
