...
import com.zs.ina.enquiry.search.editing.FXMLTrainingBatchController;
 ...
 * @author 100018
 */
public class EditBatchCell extends TableCell<CounselorDetailsBEAN, String> {
    ...
    private void createTextField() {
        ...
        textField.setOnMouseClicked(new EventHandler<MouseEvent>() {
            ...
            public void handle(MouseEvent event) {
                ...
                FXMLLoader loader = new FXMLLoader(getClass().getResource("/com/zs/ina/enquiry/search/editing/FXMLTrainingBatch.fxml"));
                try {
                    Parent root = (Parent) loader.load();
                    // System.out.println(loader.getController());
                    FXMLTrainingBatchController controller = (FXMLTrainingBatchController) loader.getController();
                    ...
                    popmsg.setTitle("View/Edit Batch Details ");
