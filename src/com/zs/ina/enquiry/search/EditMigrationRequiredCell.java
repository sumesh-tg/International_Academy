...
import com.zs.ina.enquiry.search.editing.FXMLMigrationRequiredController;
 ...
 * @author 100018
 */
public class EditMigrationRequiredCell extends TableCell<CounselorDetailsBEAN, String> {
     ...
     *
     */
    public EditMigrationRequiredCell() {
    }
    ...
    private void createTextField() {
        ...
        textField.setOnMouseClicked(new EventHandler<MouseEvent>() {
            ...
            public void handle(MouseEvent event) {
                ...
                FXMLLoader loader = new FXMLLoader(getClass().getResource("/com/zs/ina/enquiry/search/editing/FXMLMigrationRequired.fxml"));
                try {
                    Parent root = (Parent) loader.load();
                    // System.out.println(loader.getController());
                    FXMLMigrationRequiredController controller = (FXMLMigrationRequiredController) loader.getController();
                    ...
                    popmsg.setTitle("View/Edit Migration Required Details ");
