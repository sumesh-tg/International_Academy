 ...
 * @author 100035
 */
public interface TrainCourseExperienceReqDAO {

    public boolean insertTrainExperience(ExperienceReqBEAN experienceReqBEAN);

    public boolean deleteTrainExperience(String rowId);

    public boolean updateTrainExperience(ExperienceReqBEAN experienceReqBEAN);

    public ObservableList<ExperienceReqBEAN> retrieveTrainExperience(String vacancyId);
}
