 ...
 */
public class ExperienceReqBEAN {
    ...
    private final StringProperty experinceDuration = new SimpleStringProperty();
    ...
    public String getExperinceDuration() {
        return experinceDuration.get();
    }

    public void setExperinceDuration(String value) {
        experinceDuration.set(value);
    }

    public StringProperty experinceDurationProperty() {
        return experinceDuration;
    }
    ...
    public String toString() {
        return "ProfessionBEAN{" + "rowId=" + rowId + ", vacancyId=" + vacancyId + ", profession=" + profession + ", experinceDuration=" + experinceDuration + '}';
    }
